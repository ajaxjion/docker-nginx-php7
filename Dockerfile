...
RUN apt-get update && apt-get install -y \
        ...
        libpng-dev \
        libmcrypt-dev \
        libmemcached-dev zlib1g-dev libssl-dev librabbitmq-dev nginx git cron \
...
RUN docker-php-ext-enable opcache memcached redis pdo_mysql gd iconv amqp
...
RUN docker-php-ext-enable phpiredis loader_71
